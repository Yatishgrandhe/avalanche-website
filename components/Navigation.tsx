...
export default function Navigation() {
  ...
  return (
    ...
    >
        ...
        <div className="flex justify-between items-center">
          ...
          <Link href="/" className="flex items-center space-x-3 group">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-xs text-slate-400 tracking-wider group-hover:text-slate-300 transition-colors duration-300">ROBOTICS 2724</span>
            </div>
          </Link>
            ...
            {navItems.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  <div className={`absolute inset-0 bg-slate-800 scale-0 group-hover:scale-100 transition-transform duration-300 rounded-full ${isActive ? 'hidden' : ''}`}></div>
          ...
          <div className="md:hidden">
            <button
              ...
              className="text-white hover:text-accent-blue p-2 transition-colors"
            >
      ...
      {/* Mobile Menu */}
      <div
        className={`md:hidden absolute top-full left-0 right-0 bg-slate-950/95 backdrop-blur-xl border-b border-slate-800 transition-all duration-300 overflow-hidden ${mobileMenuOpen ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0'
          }`}
      >
