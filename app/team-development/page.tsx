    ...
    <div className="relative min-h-screen pb-20 overflow-hidden">
      ...
      <div className="relative pt-20 pb-16 text-center">
        <h1 className="font-display font-bold text-5xl md:text-6xl text-white mb-4 overflow-hidden h-20 flex items-center justify-center">
          <Typewriter text="TEAM DEVELOPMENT" speed={100} loop={false} cursor={true} className="text-white" />
        </h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20 animate-fade-in">
          {/* Training Card */}
          <div className="bg-slate-900/80 backdrop-blur-md p-8 rounded-2xl border border-slate-700 shadow-lg hover:border-accent-yellow/30 transition-all duration-300 hover:-translate-y-2 group relative overflow-hidden">
            ...
            <h3 className="font-display font-bold text-2xl text-white mb-4 relative z-10">TRAINING</h3>
          ...
          {/* Outreach Card */}
          <div className="bg-slate-900/80 backdrop-blur-md p-8 rounded-2xl border border-slate-700 shadow-lg hover:border-accent-cyan/30 transition-all duration-300 hover:-translate-y-2 group relative overflow-hidden">
            ...
            <h3 className="font-display font-bold text-2xl text-white mb-4 relative z-10">OUTREACH</h3>
            <ul className="space-y-3 text-slate-300 relative z-10">
              <li className="flex items-center">
          ...
          {/* Stats Card */}
          <div className="bg-slate-900/80 backdrop-blur-md p-8 rounded-2xl border border-slate-700 shadow-lg hover:border-accent-purple/30 transition-all duration-300 hover:-translate-y-2 group flex flex-col justify-center items-center text-center relative overflow-hidden">
            <div className="absolute inset-0 bg-accent-purple/10 group-hover:bg-accent-purple/20 transition-colors"></div>
            <div className="absolute top-0 right-0 w-32 h-32 bg-accent-purple/20 rounded-full blur-[50px] animate-pulse-slow"></div>
            <div className="relative z-10">
              <h3 className="font-display font-bold text-xl text-slate-400 mb-2">2025-2026 SEASON</h3>
        ...
        <div className="mb-20">
          <div className="text-center mb-12">
            <h2 className="font-display font-bold text-4xl text-white mb-4">OUR ROBOTS</h2>
            <p className="text-slate-300">Engineering excellence through the years</p>
          </div>
