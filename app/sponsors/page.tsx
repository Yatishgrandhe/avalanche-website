    ...
    <div className="relative min-h-screen pb-20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-4xl mx-auto animate-fade-in">
          <div className="bg-slate-900/80 backdrop-blur-md p-8 md:p-12 rounded-3xl border border-slate-700 shadow-xl relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="text-center mb-10">
                ...
                <p className="text-slate-300">Join us in shaping the future of STEM education.</p>
              </div>
              <SponsorForm />
            </div>
          </div>
