    ...
    <div className="relative min-h-screen pb-20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20 animate-fade-in">
          {/* Service Card */}
          <div className="bg-white p-8 rounded-2xl border border-slate-200 shadow-lg hover:border-accent-blue/30 transition-all duration-300 hover:-translate-y-2 group">
            ...
            <h2 className="font-display font-bold text-2xl text-slate-900 mb-4">SERVICE</h2>
          ...
          {/* Scholarship Card */}
          <div className="bg-white p-8 rounded-2xl border border-slate-200 shadow-lg hover:border-accent-purple/30 transition-all duration-300 hover:-translate-y-2 group">
            ...
            <h2 className="font-display font-bold text-2xl text-slate-900 mb-4">SCHOLARSHIP</h2>
            <ul className="space-y-3 text-slate-600">
              <li className="flex items-start">
          ...
          {/* Employment Card */}
          <div className="bg-white p-8 rounded-2xl border border-slate-200 shadow-lg hover:border-accent-cyan/30 transition-all duration-300 hover:-translate-y-2 group">
            ...
            <h2 className="font-display font-bold text-2xl text-slate-900 mb-4">EMPLOYMENT</h2>
            <ul className="space-y-3 text-slate-600">
              <li className="flex items-start">
        ...
        <div className="flex flex-col items-center justify-center text-center">
          <div className="bg-white p-12 rounded-3xl border border-slate-200 shadow-xl max-w-4xl w-full relative overflow-hidden group">
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center justify-center gap-12">
              ...
              <div className="text-left max-w-lg">
                <h3 className="font-display font-bold text-3xl text-slate-900 mb-4">Join the Movement</h3>
