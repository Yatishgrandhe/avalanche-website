    ...
    <div className="relative min-h-screen pb-20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20 animate-fade-in">
          {/* Service Card */}
          <div className="glass p-8 rounded-2xl border border-white/10 hover:border-accent-blue/30 transition-all duration-300 hover:-translate-y-2 group">
          ...
          {/* Scholarship Card */}
          <div className="glass p-8 rounded-2xl border border-white/10 hover:border-accent-purple/30 transition-all duration-300 hover:-translate-y-2 group">
          ...
          {/* Employment Card */}
          <div className="glass p-8 rounded-2xl border border-white/10 hover:border-accent-cyan/30 transition-all duration-300 hover:-translate-y-2 group">
        ...
        <div className="flex flex-col items-center justify-center text-center">
          <div className="glass p-12 rounded-3xl border border-white/10 max-w-4xl w-full relative overflow-hidden group">
