    ...
    <div className="relative min-h-screen pb-20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center justify-center animate-fade-in">
          ...
          {/* Main Card */}
          <div className="bg-slate-900/80 backdrop-blur-md p-12 rounded-3xl border border-slate-700 shadow-xl max-w-4xl w-full text-center relative overflow-hidden group mb-12">
